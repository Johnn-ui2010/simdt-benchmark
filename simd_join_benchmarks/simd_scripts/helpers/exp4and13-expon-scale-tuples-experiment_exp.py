...
if __name__ == '__main__':
    ...
    commons.init_file(filename_fixed_r_phases, "mode,alg,sizeR,sizeS,phase,cycles\n")
    commons.init_file(filename_fixed_s_phases, "mode,alg,sizeR,sizeS,phase,cycles\n")
    #
    for mode in modes:
